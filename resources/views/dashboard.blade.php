    ...
    <div class="w-full">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-12">
            <div class="bg-violet-600 rounded-3xl border-2 border-violet-500 border-b-4 border-b-violet-800 p-6 sm:p-8 flex flex-col sm:flex-row items-center sm:items-start gap-6 relative overflow-hidden shadow-xl shadow-violet-900/20">
                ...
                <div class="mt-4 sm:mt-0 z-10 w-full sm:w-auto flex flex-col sm:flex-row gap-3 justify-center">
                    <a href="{{ route('grades') }}" class="px-5 py-3 bg-white text-violet-600 hover:bg-slate-50 border-2 border-white border-b-4 border-b-slate-200 rounded-2xl text-sm font-black uppercase tracking-wide active:border-b-0 active:translate-y-1 transition-all flex items-center justify-center gap-2 shadow-sm">
                    ...
                    <!-- Ссылка на настройки -->
                    <a href="{{ route('profile.edit') }}" class="px-5 py-3 bg-violet-800 hover:bg-violet-700 border-2 border-violet-500 border-b-4 border-b-violet-900 rounded-2xl text-white text-sm font-black uppercase tracking-wide active:border-b-0 active:translate-y-1 transition-all flex items-center justify-center gap-2">
